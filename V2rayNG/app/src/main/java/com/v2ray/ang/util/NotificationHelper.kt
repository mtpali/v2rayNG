...
object NotificationHelper {
    ...
    private fun ensureChannelCreated(channelType: NotificationChannelType, context: Context) {
        ...
        val channel = NotificationChannel(
            ...
            if (channelType == NotificationChannelType.CORE_TEST) NotificationManager.IMPORTANCE_MIN
    ...
    private fun buildNotificationBuilder(
        ...
        return NotificationCompat.Builder(context, channelId)
            ...
            .setSilent(channelType == NotificationChannelType.CORE_TEST)
            .setPriority(if (channelType == NotificationChannelType.CORE_TEST) NotificationCompat.PRIORITY_MIN else NotificationCompat.PRIORITY_LOW)
